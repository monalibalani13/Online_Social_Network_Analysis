...
consumer_key = 'PilNZPHYlew57d0e3ypa03e5T'
consumer_secret = 'dgNNY25VfxLv1t5y5zEjHUZLjPBVQWijq8JD3tMJRCsKlQWxAD'
access_token = '932937019684204544-cRoVdCSwuxnBEbhAznqGmwjGAhr3K6U'
access_token_secret = 'BPOJzvV1Ap9aisal43pzrDHibM7Nw3BpRQL3XC0UHZA7P'
...
def read_screen_names(filename):
    ...
    screen_names = [names.rstrip('\n') for names in open(filename)]
    return screen_names
    ...
    for i in users:
        ...
        for j in users:
            ...
            if (icount<jcount):             
                ...
                friend_overlap.append((fname,sname,len(common_friends)))
            
    friend_overlap=sorted(friend_overlap, key=lambda x: (-x[2],x[0],x[1]))
...
def followed_by_hillary_and_donald(users, twitter):
    ...
    common_friend = robust_request(twitter,"users/lookup",{'user_id':common_friend},5)
    f_list = [f for f in common_friend]
    return f_list[0]['screen_name']
...
=======
    nx.draw_networkx(graph,pos,with_labels=False,node_color='blue',node_size=50,alpha=0.50,edge_color='r')
>>>>>>> 1f4202ad89f88b76ff759afeb4412ff81a44e1dd
